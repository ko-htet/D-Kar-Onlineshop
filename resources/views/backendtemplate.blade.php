...
<html lang="en">
  <head>
    ...
    <title>@yield('title') Page - Admin</title>
    <meta charset="utf-8">
  ...
  <body class="app sidebar-mini">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item {{ Request::is('brand*') ? 'active' : '' }}" href="{{ route('brand.index') }}"><i class="app-menu__icon fa fa-laptop"></i><span class="app-menu__label">Brands</span></a></li>
        ...
        <li><a class="app-menu__item {{ Request::is('subcategory*') ? 'active' : '' }}" href="{{ route('subcategory.index') }}"><i class="app-menu__icon fa fa-edit"></i><span class="app-menu__label">Subcategories</span></a></li>
        <li><a class="app-menu__item {{ Request::is('item*') ? 'active' : '' }}" href="{{ route('item.index') }}"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Items</span></a></li>
        <li><a class="app-menu__item {{ Request::is('order*') ? 'active' : '' }}" href="{{ route('order.index') }}"><i class="app-menu__icon fa fa-th-list"></i><span class="app-menu__label">Orders</span></a></li>
      </ul>
    </aside>
    @yield('content')
