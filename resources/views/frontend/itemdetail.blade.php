            ...
            <div class="col-12">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mt-50">
                        ...
                        <li class="breadcrumb-item"><a href="{{route('shoppage')}}">{{$item->subcategory->category->name}}</a></li>
                        <li class="breadcrumb-item"><a href="{{route('shoppage')}}">{{$item->subcategory->name}}</a></li>
            ...
            <div class="col-12 col-lg-5">
                <div class="single_product_desc">
                    ...
                    <div class="product-meta-data">
                        <div class="line"></div>
                        <p class="product-price">{{number_format($item->price)}} MMK</p>
                        ...
                        <div class="my-3">
                            Brand: <span>{{$item->brand->name}}</span>
                        </div>
                    </div>
                    ...
                    <!-- Add to Cart Form -->
                        ...
                        <button type="submit" class="btn amado-btn my-3 atc" data-id="{{ $item->id }}"
